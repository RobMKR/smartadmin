<?php
namespace MgpLabs\SmartAdmin\Modules\Coordinate;


trait Converter
{
    /**
     * Convert UTM locations to Lat Lon
     *
     * @param $north
     * @param $east
     * @param int $utmZone
     * @return mixed
     */
    public function UtmToLatLon($north, $east, $utmZone = 38)
    {
    ...
    /**
     * Get Distance from 2 coordinates (LAT1,LON1, LAT2,LON2)
     *
     * @param $latitudeFrom
     * @param $longitudeFrom
     * @param $latitudeTo
     ...
     * @return float
     */
    public function latLonToDistance($latitudeFrom, $longitudeFrom, $latitudeTo, $longitudeTo, $type = 'm'){
        switch($type){
            case 'Km' :
                // Kilometers
                $earthRadius = 6371;
